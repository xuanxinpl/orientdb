 ...
 */
public class OVariableUnsignedIntegerEncoder_V0 implements OUnsignedIntegerEncoder {

  private static final int MIN_SIZE = OBase128IntegerUtils.sizeOfUnsigned(0);
  private static final int MAX_SIZE = Math
      .max(OBase128IntegerUtils.sizeOfUnsigned(Integer.MIN_VALUE), OBase128IntegerUtils.sizeOfUnsigned(Integer.MAX_VALUE));
  ...
  public int exactSizeInteger(int value) {
    return OBase128IntegerUtils.sizeOfUnsigned(value);
  }

  @Override
  public void encodeInteger(int value, Stream stream) {
    OBase128IntegerUtils.writeUnsigned(value, stream);
  }

  @Override
  public int decodeInteger(Stream stream) {
    return OBase128IntegerUtils.readUnsignedInteger(stream);
  }
